...
*/
    ...
    public static void executeMoveOld()
    {
        ...
        { //are the coordinates entered legal?

            if (gameboard.board[oldx][oldy] != null)
            { // is there a piece in the chosen spot?

                //if (gameboard.board[oldx][oldy].canMove(oldx, oldy, newx, newy, false)){

                if ((whiteTurn && gameboard.board[oldx][oldy].isWhite()) || (!whiteTurn && !gameboard.board[oldx][oldy].isWhite()))
                {
                    //does the piece being moved belong to the player whos turn it is?
                    if (gameboard.board[newx][newy] == null)
                    { // is the new location empty?
                    ...
                    else if ((whiteTurn && !gameboard.board[newx][newy].isWhite()) || (!whiteTurn && gameboard.board[newx][newy].isWhite()))
                    {
                        // is it the correct coloured piece in the old spot, and the opposite coloured in the new spot?
